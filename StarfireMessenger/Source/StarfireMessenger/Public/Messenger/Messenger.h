...
private:
	...
	// They have been deprecated to produce a Messenger specific message related to why that call/params are invalid
#if CPP
	#define STARFIRE_MESSENGER_HPP
	#include "../../Private/Messenger/Deleted_BroadcastOverloads.hpp"
	#include "../../Private/Messenger/Deleted_ListeningOverloads.hpp"
