...
//////////////////////////////////////////////////////////////////////////
// UK2Node_MakeStruct_COPY


UK2Node_MakeStruct_COPY::FMakeStructPinManager::FMakeStructPinManager(const uint8* InSampleStructMemory, UBlueprint* InOwningBP)
...
void UK2Node_MakeStruct_COPY::FMakeStructPinManager::GetRecordDefaults(FProperty* TestProperty, FOptionalPinFromProperty& Record) const
{
	UK2Node_StructOperation_COPY::FStructOperationOptionalPinManager::GetRecordDefaults(TestProperty, Record);
...
void UK2Node_MakeStruct_COPY::FMakeStructPinManager::CustomizePinData(UEdGraphPin* Pin, FName SourcePropertyName, int32 ArrayIndex, FProperty* Property) const
{
	UK2Node_StructOperation_COPY::FStructOperationOptionalPinManager::CustomizePinData(Pin, SourcePropertyName, ArrayIndex, Property);
	if (Pin && Property)
	{
...
bool UK2Node_MakeStruct_COPY::FMakeStructPinManager::CanTreatPropertyAsOptional(FProperty* TestProperty) const
{
	return CanBeExposed(TestProperty, OwningBP);
}

UK2Node_MakeStruct_COPY::UK2Node_MakeStruct_COPY(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
	, bMadeAfterOverridePinRemoval(false)
{
}

void UK2Node_MakeStruct_COPY::AllocateDefaultPins()
{
	if (StructType)
	{
...
void UK2Node_MakeStruct_COPY::PreloadRequiredAssets()
{
	PreloadObject(StructType);
	Super::PreloadRequiredAssets();
}

void UK2Node_MakeStruct_COPY::ValidateNodeDuringCompilation(class FCompilerResultsLog& MessageLog) const
{
...
FText UK2Node_MakeStruct_COPY::GetNodeTitle(ENodeTitleType::Type TitleType) const 
{
...
FText UK2Node_MakeStruct_COPY::GetTooltipText() const
{
	if (StructType == nullptr)
	{
...
FSlateIcon UK2Node_MakeStruct_COPY::GetIconAndTint(FLinearColor& OutColor) const
{
	static FSlateIcon Icon(FAppStyle::GetAppStyleSetName(), "GraphEditor.MakeStruct_16x");
	return Icon;
}

FLinearColor UK2Node_MakeStruct_COPY::GetNodeTitleColor() const
{
...
bool UK2Node_MakeStruct_COPY::CanBeMade(const UScriptStruct* Struct, const bool bForInternalUse)
{
...
bool UK2Node_MakeStruct_COPY::CanBeSplit(const UScriptStruct* Struct, UBlueprint* InBP)
{
	if (CanBeMade(Struct))
	{
...
FNodeHandlingFunctor* UK2Node_MakeStruct_COPY::CreateNodeHandler(FKismetCompilerContext& CompilerContext) const
{
	return new FKCHandler_MakeStruct(CompilerContext);
}

UK2Node::ERedirectType UK2Node_MakeStruct_COPY::DoPinsMatchForReconstruction(const UEdGraphPin* NewPin, int32 NewPinIndex, const UEdGraphPin* OldPin, int32 OldPinIndex) const
{
...
void UK2Node_MakeStruct_COPY::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
#if 0
	Super::SetupMenuActions(ActionRegistrar, FMakeStructSpawnerAllowedDelegate::CreateStatic(&UK2Node_MakeStruct_COPY::CanBeMade), EGPD_Input);
#endif
}

FText UK2Node_MakeStruct_COPY::GetMenuCategory() const
{
	return FEditorCategoryUtils::GetCommonCategory(FCommonEditorCategory::Struct);
}

void UK2Node_MakeStruct_COPY::PreSave(FObjectPreSaveContext SaveContext)
{
...
void UK2Node_MakeStruct_COPY::PostPlacedNewNode()
{
...
void UK2Node_MakeStruct_COPY::Serialize(FArchive& Ar)
{
	Super::Serialize(Ar);
...
void UK2Node_MakeStruct_COPY::ConvertDeprecatedNode(UEdGraph* Graph, bool bOnlySafeChanges)
{
	const UEdGraphSchema_K2* Schema = GetDefault<UEdGraphSchema_K2>();
