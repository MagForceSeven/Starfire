...
UCLASS( )
class STARFIREUTILITIES_API UBlueprintContainerExtensions : public UBlueprintFunctionLibrary
{
	GENERATED_BODY( )
public:
	...
	*/
	UFUNCTION( BlueprintPure, CustomThunk, meta = (DisplayName = "Get", CompactNodeTitle = "GET", SetParam = "TargetSet|Item", AutoCreateRefTerm = "Item", BlueprintThreadSafe), Category = "Utilities|Set" )
	 ...
	 */
	UFUNCTION(BlueprintPure, CustomThunk, meta=(DisplayName = "Last Index", CompactNodeTitle = "LAST INDEX", SetParam = "TargetSet", BlueprintThreadSafe), Category="Utilities|Set")
	 ...
	 */
	UFUNCTION( BlueprintPure, CustomThunk, meta =(DisplayName = "Get", CompactNodeTitle = "GET", MapParam = "TargetMap", MapKeyParam = "Key", MapValueParam = "Value", AutoCreateRefTerm = "Key, Value", BlueprintThreadSafe), Category = "Utilities|Map" )
	static void Map_Get( const TMap< int32, int32 > &TargetMap, int32 Index, int32 &Key, int32 &Value );

	DECLARE_FUNCTION( execMap_Get );

	static void GenericMap_Get( void *TargetMap, const FMapProperty *MapProperty, int32 Index, void *Key, void *Item );
	 ...
	 */
	UFUNCTION(BlueprintPure, CustomThunk, meta=(DisplayName = "Last Index", CompactNodeTitle = "LAST INDEX", MapParam = "TargetMap", BlueprintThreadSafe), Category="Utilities|Map")
